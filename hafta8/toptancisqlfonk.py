...
class sql:
    ...
    def rapor1(self):
        ...
        print("-" * 50)
        print("Depolarda bulunan toplam Mercimek",kilogram[0], "KG dır.")
        self.cur.execute("SELECT SUM(kg) FROM depo where bakliyat_ismi  =? ", ("Nohut",))
        kilogram = self.cur.fetchall()
        print("Depolarda bulunan toplam Nohut",kilogram[0], "KG dır.")
        self.cur.execute("SELECT SUM(kg) FROM depo where bakliyat_ismi  =? ", ("Fasulye",))
        kilogram = self.cur.fetchall()
        print("Depolarda bulunan toplam Fasulye",kilogram[0], "KG dır.")
        self.cur.execute("SELECT SUM(kg) FROM depo where bakliyat_ismi  =? ", ("Pirinç",))
        kilogram = self.cur.fetchall()
        print("Depolarda bulunan toplam Pirinç",kilogram[0], "KG dır.")
        print("-"*50)
    def rapor2(self):
        ...
        print("-" * 50)
        print("1 Numaralı Depoda Mevcut ", adet[0], " Kutu Mercimek Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("1 Numaralı Depoda Mevcut ", adet[0], " Kutu Nohut Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("1 Numaralı Depoda Mevcut ", adet[0], " Kutu Pirinc Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("1 Numaralı Depoda Mevcut ", adet[0], " Kutu Fasulye Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("-" * 50)
        print("2 Numaralı Depoda Mevcut ", adet[0], " Kutu Mercimek Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("2 Numaralı Depoda Mevcut ", adet[0], " Kutu Nohut Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("2 Numaralı Depoda Mevcut ", adet[0], " Kutu Pirinc Toplam",kilogram[0], "KG dır.")
        ...
        adet=self.cur.fetchall()
        print("2 Numaralı Depoda Mevcut ", adet[0], " Kutu Fasulye Toplam",kilogram[0], "KG dır.")
        print("-" * 50)
