...
class sql:
    ...
    def rapor1(self):
        ...
        print("-" * 50)
        print("Depolarda bulunan toplam Mercimek",kilogram[0][0]*adet[0][0], "KG dır.")
        ...
        adet = self.cur.fetchall()
        kilogram = self.cur.fetchall()
        print("Depolarda bulunan toplam Nohut",kilogram[0][0]*adet[0][0], "KG dır.")
    ...
    def rapor2(self):
        ...
        adet=self.cur.fetchall()
        print("-" * 50)
        print("1 Numaralı Depoda ", adet[0][0], " Kutu Mercimek Mevcuttur. Toplam",adet[0][0]*kilogram[0][0], "KG dır.")
